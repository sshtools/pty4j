...
public class OSFacadeImpl implements PtyHelpers.OSFacade {
	...
	// VARIABLES
	private static FreeBSD_C_lib m_Clib = Native.loadLibrary("c", FreeBSD_C_lib.class);
	private static FreeBSD_Util_lib m_Utillib = Native.loadLibrary("util", FreeBSD_Util_lib.class);
